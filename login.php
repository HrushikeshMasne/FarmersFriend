 ...
 include('dbcon.php');             //db connection added
	...
	<div class="row">
		...
		<div class="span4">
			...
			<h5>ALREADY REGISTERED ?</h5>
			  ...
			  <div class="control-group">
				...
				<div class="controls">
				  <input class="span3"  type="text" name="email" placeholder="Email" required="required">
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputPassword1">Password</label>
				<div class="controls">
				  <input type="password" class="span3"  name="password" placeholder="Password" required="required">
				</div>
			  </div>
			  <div class="control-group">
				<div class="controls">
		...
		<div class="span4">
			...
			<form action="register.php">
			  <div class="controls">
			 <center> <button type="submit" class="btn block">Create Your Account</button></center>
			  </div>
			</form>
		</div>
		</div>
...
<!-- Footer ================================================================== -->
	...
	<div class="container">
		...
		<p class="pull-right">&copy; Farmer'sFriend</p>
	</div><!-- Container End -->
	</div>
